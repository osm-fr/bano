...
def format_toponyme(s):
    ...
    dic_replace_accents["EGLISE"] = "ÉGLISE"
    dic_replace_accents["ILE"] = "ÎLE"
    dic_replace_accents["ILOT"] = "ÎLOT"
    dic_replace_accents["PRE"] = "PRÉ"
...
def normalize(s):
    ...
    s = s.replace("(", "").replace(
        ")", ""
    )  # parenthèses : on supprime cf Fantoir pour les anciennes communes en suffixe
