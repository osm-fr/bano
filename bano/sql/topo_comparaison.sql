...
EXCEPT
SELECT code_insee,code_insee AS code, 'communes apparues'  AS test,false::boolean AS a_supprimer,true::boolean AS a_ajouter,false::boolean AS a_maj FROM topo       WHERE type_voie != 'B'
UNION ALL
SELECT code_insee,code_insee AS code, 'communes disparues' AS test,true::boolean AS a_supprimer,false::boolean AS a_ajouter,false::boolean AS a_maj FROM topo       WHERE type_voie != 'B'
EXCEPT
...
EXCEPT
SELECT code_insee,fantoir    AS code, 'fantoirs apparus'   AS test,false::boolean AS a_supprimer,false::boolean AS a_ajouter,true::boolean AS a_maj FROM topo       WHERE type_voie != 'B'
UNION ALL
SELECT code_insee,fantoir    AS code, 'fantoirs disparus'  AS test,false::boolean AS a_supprimer,false::boolean AS a_ajouter,true::boolean AS a_maj FROM topo       WHERE type_voie != 'B'
EXCEPT
