SELECT	l.name,l.tags->'ref:FR:FANTOIR' f,l.tags->'ref:FR:FANTOIR:left' fl,l.tags->'ref:FR:FANTOIR:right' fr,h.suffixe
		...
		WHERE	p.tags ? 'ref:INSEE'			AND
				...
				group by 1,2,3,4,5
UNION
SELECT	pl.name,pl.tags->'ref:FR:FANTOIR' f,pl.tags->'ref:FR:FANTOIR:left' fl,pl.tags->'ref:FR:FANTOIR:right' fr,h.suffixe
		FROM	planet_osm_polygon 	p
