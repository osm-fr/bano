...
INSERT INTO fantoir_voie (SELECT CASE
	                             ...
	                             substr(raw,7,4) as id_voie,
	                             substr(raw,1,2)||substr(raw,4,3)||substr(raw,7,4) as fantoir,
	                             substr(raw,1,2)||substr(raw,4,3)||substr(raw,7,4)||substr(raw,11,1) as fantoir10,
	                             substr(raw,11,1) as cle_rivoli,
