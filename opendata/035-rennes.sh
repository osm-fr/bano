...
# import dans postGIS
ogr2ogr -t_srs EPSG:4326 -f PostgreSQL PG:dbname=cadastre voies_adresses_shp_wgs84/donnees/rva_adresses.shp  -overwrite -nlt GEOMETRY -nln import_rennes_addr
...
psql cadastre -c "\\copy import_rennes_voies from 'voies_adresses_csv/donnees/rva_voies.csv' with DELIMITER AS ';' csv header;"
